...
# # Initialize model
# llm = ChatOpenAI(
#     model="gpt-4o-mini",   # You can replace with another OpenRouter model if needed
#     temperature=0.3,
...
#
# # -------------------------------------------------------------
# # 🧩 Prompt Template (Your chosen one)
# # -------------------------------------------------------------
...
# - Decisions finalized
#
# Use a clean bullet or numbered format, making it easy for readers to skim.
#
# ---
#
...
#
# # -------------------------------------------------------------
# # 🧩 Function to process uploaded meeting file
# # -------------------------------------------------------------
# def analyze_meeting_docx(file):
#     """
#     Process uploaded .docx meeting transcript:
#     - Extract text
#     - Format prompt
