...
//
//      html += `<h4>Sector Breakdown</h4>
//<table border="1" cellpadding="8" cellspacing="0">
//<thead><tr><th>Sector</th><th>Weight</th></tr></thead><tbody>`;
//
...
//
//      html += `<h4>Sector Chart</h4>
//<img src="data:image/png;base64,${data.sector_chart_base64}" alt="Sector Chart" style="max-width:100%;">`;
//
//    }
//
...
//    document.getElementById("loading").style.display = "none";
//
//    document.getElementById("portfolioResults").innerHTML = `<p style="color:red;">Error: ${error.message}</p>`;
//
//  }
//
//});
