...
////<p><strong>News Summary:</strong> ${data.news_summary}</p>
////
////    `;
////
////    // Chart rendering if base64 exists
////
...
////
////      const labels = data.sentiment_results.map(r => r.label);
////
////      const values = data.sentiment_results.map(r => r.value);
////
////      new Chart(ctx, {
////
////        type: 'pie',
...
//<h4>News Summary</h4>
//<pre>${data.news_summary}</pre>
//    `;
//
//    // Stock Data Table
//    if (data.stock_data && data.stock_data.length > 0) {
//      html += `<h4>Stock Data</h4>
...
//  }
//});
// Include marked.js in your dashboard.html before script.js
...
//
//// later:
//html += `<div class="markdown">${marked.parse(data.insights)}</div>`;
//
//document.getElementById("queryForm").addEventListener("submit", async function(e) {
//
//  e.preventDefault();
...
//    }
//
//    // Render News Summary (Markdown → HTML)
//
